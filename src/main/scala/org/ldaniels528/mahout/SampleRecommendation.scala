...
object SampleRecommendation {
  ...
  def main(args: Array[String]): Unit = {
    ...
    /*
     * In this example, we want to create a user-based recommender. The idea behind this approach is that
    ...
    /*
     * he next thing we have to do is to define which similar users we want to leverage for the recommender.
